...
\begin{enumerate}
    ...
    \item \textbf{ML cannot bridge the gap:} The best classifier achieves F1 = 0.47 thereby confirming that the feature space does not cleanly partition into latency classes.
